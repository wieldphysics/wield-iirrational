...
def test_imcheby_convergence():
    ...
    fitter.fit_poles()
    fitter.fit_zeros()
    fitter.matched_pairs_clear(Q_rank_cutoff = .3)
    ...
    fitter.fit_poles()
    fitter.fit_zeros()
    fitter.matched_pairs_clear(Q_rank_cutoff = .7)
...
def test_imcheby_convergence_alpha():
    ...
    fitter.fit_poles()
    fitter.fit_zeros()
    fitter.matched_pairs_clear(Q_rank_cutoff = .1)

    print("Z: ", fitter.ZPKrep.zeros)
    print("P: ", fitter.ZPKrep.poles)

    #from IIRrational import fitters_ZPK
